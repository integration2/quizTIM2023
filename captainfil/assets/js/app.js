...
const quiz = {
    ...
    afficherResultats: function () {
        ...
        document.getElementById("feedback").innerHTML = "Votre résultat est : </br>" + this.intBonneReponse + "/3";
     },
     rejouer: function(){
        quiz.intBonneReponse = 0;
        quiz.intQuestion = 0;
        document.querySelector('.quiz').classList.add("hidden")
        document.getElementById("resultat").classList.add("hidden")
        document.querySelectorAll('fieldset').forEach(function(item){
...
document.getElementById("resultat").addEventListener("click", quiz.rejouer());
