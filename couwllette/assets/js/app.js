...
function initialisation() {
    ...
    refBoutonStart.addEventListener('click', demarrerQuiz)
...
function demarrerQuiz() {
    ...
    for (let i = 0; i < t.length; i++) {
        t[i].classList.remove("reussi", "incorrect");
        t[i].checked = false;
        t[i].disabled = false;
    }
...
function afficherQuestion(numeroQuestion) {
    ...
    arrQuestions[numeroQuestion].querySelector('.erreur').innerHTML = "";
    arrQuestions[numeroQuestion].querySelector(".message-retroaction").classList.add('visuallyhidden');
    arrQuestions[numeroQuestion].querySelector(".message-retroaction").innerHTML = "";
    ...
    refBtnValider.querySelector('button').addEventListener('click', validerReponse);
