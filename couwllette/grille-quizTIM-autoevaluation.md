...
Les seuls "erreurs" se sont des "warnings" qui indiquent que les roles ajoutés dans le HTML ne sont pas nécessaires.
Je n'ai pas intégrer des images réactives, seulement des img.
__Note (A-E)__: B
...
__BONUS (A-E)__: A
__Commentaire__:
J'ai ajouté la fonction recommencer/redémarrer le quiz dans le JavaScript. 
